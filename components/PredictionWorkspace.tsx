...
import { timingText } from '@/lib/watchlist-recommendations.mjs'
...
type Prediction = {
  ...
  benchmark_symbol: string | null; currency: string; entry_rule: string; exit_rule: string; entry_delay_sessions: number; holding_sessions: number | null; timing_reason: string | null;
}
type Result = {
