    ...
    <div style={{ width: '100%', height: 320 }}>
      <ResponsiveContainer>
        <LineChart data={data} margin={{ top: 12, right: 18, bottom: 8, left: 0 }}>
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="opportunity" name="Opportunity" strokeWidth={3} dot={false} connectNulls />
          <Line type="monotone" dataKey="structural" name="Structural" strokeWidth={2} dot={false} connectNulls />
          <Line type="monotone" dataKey="technology" name="Technology Inflection" strokeWidth={2} dot={false} connectNulls />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
