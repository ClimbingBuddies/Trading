...
## Current project state
    ...
    next_action: Producer makes the exact MYDASH-003 candidate safely runnable in Preview, supplies bounded two-user authenticated test access, completes desktop and 390 × 844 keyboard/state evidence, and returns the gate to independent audit without merging PR #25.
