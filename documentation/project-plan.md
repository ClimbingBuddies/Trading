...
| DOC-006 | **IN PROGRESS** | Refresh roadmap and Phase 2 progress | Roadmap reflects the current two-assessment architecture. |
...
**Current work:** `DOC-006 — IN PROGRESS — Refresh roadmap and Phase 2 progress`.
