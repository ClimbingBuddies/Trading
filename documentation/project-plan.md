...
| DOC-006 | **NEXT** | Refresh roadmap and Phase 2 progress | Roadmap reflects the current two-assessment architecture. |
...
**Current work:** `DOC-006 — NEXT — Refresh roadmap and Phase 2 progress`.
